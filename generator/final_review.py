...
- 保持每个条目的信息密度，除非证据不足，不要把 420-680 字的图片文案压缩成短摘要
...
- Preserve useful verified detail. For article-backed or multi-evidence topics, keep content roughly 420-680 Chinese characters and target about 560; do not shorten below 420 unless the supporting evidence is genuinely thin
