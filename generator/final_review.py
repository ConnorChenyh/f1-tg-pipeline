...
- 保持每个条目的信息密度，除非证据不足，不要把 320-500 字的图片文案压缩成短摘要
...
- Preserve useful verified detail. Do not shorten an item below roughly 320 Chinese characters unless the supporting evidence is genuinely thin
